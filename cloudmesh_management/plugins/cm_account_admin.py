...
class cm_account_admin:
    ...
    def do_management(self, args, arguments):
        ...
        Usage:
            ...
            management committee user list [USERNAME] [--format=FORMAT]
            management committee user status [USERNAME]
            management committee user approve [USERNAME]
            management committee user deny [USERNAME]
        ...
        try:
            ...
            #
            #
            elif arguments['committee'] and arguments['user'] and arguments['list']:
                user = Users()
                display_fmt = None
                user_name = None
                if arguments['--format']:
                ...
                if arguments['USERNAME']:
                    user_name = arguments['USERNAME']
                user.list_users(display_fmt, user_name)
            elif arguments['committee'] and arguments['user'] and arguments['status']:
                user = Users()
                Console.info(
                    "Status of user " + arguments['USERNAME'] + " " + user.get_user_status(arguments['USERNAME']))
            elif arguments['committee'] and arguments['user'] and arguments['approve']:
                if arguments['USERNAME']:
                    user = Users()
                    user.amend_user_status(arguments['USERNAME'], new_status='approved')
                    Console.info("User " + arguments['USERNAME'] + " approved.")
                    ...
                    Console.error("Please specify a user to be amended")
            elif arguments['committee'] and arguments['user'] and arguments['deny']:
                if arguments['USERNAME']:
                    user = Users()
                    user.amend_user_status(arguments['USERNAME'], new_status='denied')
                    Console.info("User " + arguments['USERNAME'] + " denied.")
